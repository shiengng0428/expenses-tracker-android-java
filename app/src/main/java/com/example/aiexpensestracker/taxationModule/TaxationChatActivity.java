...
import com.example.aiexpensestracker.taxationModule.Message;
import com.example.aiexpensestracker.taxationModule.MessageAdapter;
...
public class TaxationChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taxation_chat);

        getSupportActionBar().setTitle("Taxation Chatbox");
